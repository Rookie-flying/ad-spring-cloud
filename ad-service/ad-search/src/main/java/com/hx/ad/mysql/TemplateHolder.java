package com.hx.ad.mysql;

import com.alibaba.fastjson.JSON;
import com.hx.ad.mysql.constant.OpType;
import com.hx.ad.mysql.dto.ParseTemplate;
import com.hx.ad.mysql.dto.TableTemplate;
import com.hx.ad.mysql.dto.Template;
...
public class TemplateHolder {
    ...
    private void loadMeta() {
        ...
        for (Map.Entry<String, TableTemplate> entry :
            ...
            final List<String> updateFields = table.getOpTypeFieldSetMap().get(
                    OpType.UPDATE
            );

            final List<String> insertFields = table.getOpTypeFieldSetMap().get(
                    OpType.ADD
            );

            final List<String> deleteFields = table.getOpTypeFieldSetMap().get(
                    OpType.DELETE
            );
            ...
            jdbcTemplate.query(SQL_SCHEMA, new Object[]{
                ...
                if ((null != updateFields && updateFields.contains(colName))
                    ...
                    table.getPostMap().put(pos - 1, colName);
                }
